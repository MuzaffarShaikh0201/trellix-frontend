...
const CustomLoader = ({
	...
	useEffect(() => {
		...
		if (!document.getElementById("layers-loader-styles")) {
			const style = document.createElement("style");
			style.id = "layers-loader-styles";
			style.innerHTML = `        
        .layers-loader g > path:nth-child(1),
        .layers-loader g > path:nth-child(2) {
          animation: layer1 3s ease-in-out infinite;
        }
        
        .layers-loader g > path:nth-child(3) {
          animation: layer2 3s ease-in-out infinite 0.3s;
        }
        
        .layers-loader g > path:nth-child(4) {
          animation: layer3 3s ease-in-out infinite 0.6s;
        }
